...
#ifndef ONEMATH_SYCL_BLAS_OPERATORS_HPP
#define ONEMATH_SYCL_BLAS_OPERATORS_HPP
...
struct AbsoluteValue {
  ...
  template <typename value_t>
  static ONEMATH_SYCL_BLAS_INLINE value_t eval(
      const value_t &val,
  ...
  template <typename value_t>
  static ONEMATH_SYCL_BLAS_INLINE value_t
...
struct AdditionIdentity : public Operators {
  ...
  static ONEMATH_SYCL_BLAS_INLINE rhs_t eval(const rhs_t) {
...
struct ProductIdentity : public Operators {
  template <typename rhs_t>
  static ONEMATH_SYCL_BLAS_INLINE rhs_t eval(const rhs_t r) {
...
struct HypotenuseOperator : public Operators {
  ...
  static ONEMATH_SYCL_BLAS_INLINE rhs_t eval(const lhs_t l, const rhs_t r) {
...
struct AddOperator : public Operators {
  ...
  template <typename rhs_t>
  constexpr static ONEMATH_SYCL_BLAS_INLINE typename rhs_t::value_t init() {
    return constant<typename rhs_t::value_t, const_val::zero>::value();
  }

  template <typename element_t, typename index_t>
  static ONEMATH_SYCL_BLAS_INLINE element_t get_final_value(const element_t &l,
                                                   const index_t &) {
    return l;
  }
};
...
struct MeanOperator : public Operators {
  ...
  static ONEMATH_SYCL_BLAS_INLINE element_t eval(const element_t &accumulator,
                                        const element_t &val) {
...
struct CollapseIndexTupleOperator : public Operators {
  template <typename lhs_t, typename rhs_t>
  static ONEMATH_SYCL_BLAS_INLINE
