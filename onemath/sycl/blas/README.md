...
- [Implementation](#implementation)
  ...
  - [Usage as oneMath backend](#Usage-in-oneMath)
...
The best way to utilize this header-only library it through oneMath open-source
library. The documentation on how to build and use it is provided in [oneMath
repository](https://uxlfoundation.github.io/oneMath/building_the_project_with_dpcpp.html#building-for-onemath-generic-sycl-blas)
...
library follows the
[oneAPI Math Library BLAS specification](https://uxlfoundation.github.io/oneAPI-spec/spec/elements/oneMath/source/domains/blas/blas.html)
